...
<html>
<head>
<title>Photo&Video Archives | Droid4apps</title>
<meta charset="utf-8">
        ...
        <div class="content_bottom_left">
          <div class="single_category wow fadeInDown">
            <div class="archive_style_1">
              ...
              $sql = "SELECT * FROM data_post WHERE post_type = 2 ORDER BY post_id DESC LIMIT $x,10";
        ...
        <div class="pagination_area">
          <nav>
            <ul class="pagination">
              ...
              $sql = "SELECT * FROM data_post WHERE post_type = 2";
              $query = mysqli_query($DBConect,$sql);
            ...
            <div class="tab-content">
              <div id="mostPopular" class="tab-pane fade in active" role="tabpanel">
                <ul class="small_catg popular_catg wow fadeInDown">
                  ...
                  $sql = "SELECT * FROM data_post WHERE post_type = 2 ORDER BY post_view  DESC LIMIT 5";
                  $query = mysqli_query($DBConect,$sql);
