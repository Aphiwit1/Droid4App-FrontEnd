...
<html>
<head>
<title>NewsAndroid Archives | Droid4apps</title>
<meta charset="utf-8">
        ...
        <div class="content_bottom_left">
          <div class="single_category wow fadeInDown">
            <div class="archive_style_1">
              ...
              $sql = "SELECT * FROM data_post WHERE post_type = 6 ORDER BY post_id DESC LIMIT $x,10";
        ...
        <div class="pagination_area">
          <nav>
            <ul class="pagination">
              ...
              $sql = "SELECT * FROM data_post WHERE post_type = 6";
              $query = mysqli_query($DBConect,$sql);
